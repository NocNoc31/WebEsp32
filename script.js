...
function onMessage(event) {
    ...
    const distanceNow = parseFloat(data.distance_now); // Chuyển đổi sang số
    document.getElementById("distance_now").innerText = distanceNow;
    updateChart(distanceNow);
